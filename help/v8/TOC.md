...
+ Notas de versão {#release-notes}
   ...
   + [Notas de versão antecipadas](rn/e-release-notes.md)
...
+ Mensagens e entregas {#msg}
   ...
   + [Acessar deliveries](msg/gs-deliveries.md)
   + [Criação de uma entrega](msg/create-deliveries.md)
...
+ Gestão de conteúdo {#content}
   ...
   + Assistente de IA para o Acelerador de Conteúdo {#ai-assistant}
      + [Trabalhar com o assistente de IA - Acelerador de conteúdo](email/generative-gs.md)
...
+ Relatórios {#reports}
   ...
   + Relatórios do Campaign {#campaign-report}
      ...
      + [Relatório de campanha de correspondência direta](reporting/campaign-reports-direct-mail.md)
