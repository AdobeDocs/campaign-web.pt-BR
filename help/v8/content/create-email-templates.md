...
1. A janela Email Designer é exibida. Edite o conteúdo conforme necessário, da mesma forma que faria para qualquer email, de acordo com a opção selecionada. Saiba como usar o Designer de Email em [esta seção](../email/get-started-email-designer.md).
...
Depois de [criar um email](../email/create-email-content.md), você pode salvar esse conteúdo como um modelo para reutilização futura. Os modelos salvos estão disponíveis para todos os usuários do seu ambiente Adobe Campaign.
...
1. Clique no botão **[!UICONTROL Editar conteúdo]** para atualizar seu conteúdo com o [Designer de email](../email/get-started-email-designer.md).
