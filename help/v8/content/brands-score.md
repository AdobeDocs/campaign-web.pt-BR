...
# Avaliar seu conteúdo {#brands-score}
...
* **Alinhamento da marca**: analise e gerencie conteúdo que se mantenha fiel às diretrizes da sua marca. Isso garante a consistência no tom, nas mensagens e na identidade visual em suas campanhas de email.
* **Verificação de qualidade**: valide seu conteúdo antes que ele entre em vigor para manter altos padrões e a integridade da marca.
...
1. Crie sua [entrega de email](../email/create-email.md).
