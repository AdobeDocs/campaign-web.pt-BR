...
ht-degree: 0%
---
# Casos de uso do recurso Gerar conteúdo {#generative-uc}
...
![Demonstração de reutilização de conteúdo existente com Gerar conteúdo](assets/do-not-localize/gen-ai-reuse-text.gif)
...
1. Ative o recurso **[!UICONTROL Usar conteúdo original]** em Gerar conteúdo para adaptar o novo conteúdo de acordo com os detalhes da entrega, incluindo o nome da entrega e o público-alvo direcionado.
...
![Demonstração de variações de conteúdo de refinamento com Gerar Conteúdo](assets/do-not-localize/gen-ai-variation.gif)
...
1. Na janela **[!UICONTROL Visualizar]**, vá para a opção **[!UICONTROL Refinar]** para personalização adicional, incluindo:
   ...
   * **[!UICONTROL Elaborar]**: use a IA para detalhar determinados pontos, oferecendo mais profundidade e detalhes para um melhor engajamento.

   * **[!UICONTROL Resumir]**: para obter informações mais longas, use a IA para editar/refinar conteúdo, criando resumos concisos que são mais fáceis de serem resumidos pelos destinatários de email.

   * **[!UICONTROL Refrase]**: use a IA para editar/refinar sua mensagem, apresentando-a de diferentes maneiras para ajudar a manter o conteúdo atualizado para uma variedade de públicos-alvo.

   * **[!UICONTROL Usar linguagem mais simples]**: use a IA para editar/refinar a linguagem, garantindo que a mensagem seja clara e acessível a todos os leitores.
...
![Demonstração de geração de imagens semelhantes com Gerar conteúdo](assets/do-not-localize/uc-image-similar.gif)
...
![Demonstração de carregamento de uma referência de estilo para Gerar Conteúdo](assets/do-not-localize/uc-image-reference.gif)
...
1. Escolha o ativo que deseja modificar.

1. No menu do painel direito, escolha **[!UICONTROL Gerar conteúdo]**.

1. Ative a opção **[!UICONTROL Estilo de referência]** para usar a IA para gerar novo conteúdo usando o material de referência.
...
![Demonstração animada do conteúdo gerado em vários idiomas, incluindo francês, espanhol e alemão](assets/do-not-localize/ai-language.gif)

Produza texto nos idiomas compatíveis com a IA, combinando seu prompt com configurações de idioma explícitas.
...
![Demonstração animada de Geração de conteúdo de geração com conteúdo de referência](assets/do-not-localize/gen-url.gif)

Você pode contextualizar a IA adicionando **conteúdo de referência**, uma página da Web ou arquivos carregados, de modo que a cópia gerada e as sugestões fiquem mais próximas do material de origem.
...
1. Clique em ![Ícone de carregamento](assets/do-not-localize/Smock_UploadToCloudOutline_18_N.svg) para buscar a página e adicioná-la como conteúdo de referência para geração.
...
![Demonstração animada de Gerar conteúdo gerando conteúdo com modelo personalizado](assets/do-not-localize/gen-ai-model.gif)
...
1. Selecione o ativo a ser modificado e abra o menu **[!UICONTROL Gerar conteúdo]**.
...
![Demonstração animada de Gerar conteúdo gerando conteúdo com o Gemini como modelo gerativo](assets/do-not-localize/gen-nano.gif)
