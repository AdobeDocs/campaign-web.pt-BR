...
>additional-url="https://experienceleague.adobe.com/docs/campaign-web/v8/conf/schemas/schemas-custom-filters.html" text="Adicionar filtros personalizados"
...
1. Escolha **[!UICONTROL Selecionar colunas]**.
   ![Configuração de colunas da lista](assets/schemas-list-columns2.png)

1. Selecione os atributos que deseja exibir nas exibições de lista e confirme.

   ![Configuração de colunas da lista](assets/schemas-list-columns.png)
...
1. Navegue até o menu **Perfis** para acessar a exibição da lista de perfis. Você observa que as novas guias são exibidas. Você pode adicionar mais colunas, se necessário.
   ...
   ![Configuração de colunas da lista](assets/schemas-list-columns3.png)
