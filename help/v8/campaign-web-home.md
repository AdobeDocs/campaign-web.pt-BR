...
* [Pixels de rastreamento de email e orientação da CNIL](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/new/cnil-pixel-tracking){target="_blank"}