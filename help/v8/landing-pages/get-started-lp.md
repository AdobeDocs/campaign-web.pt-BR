...
No contexto de campanhas de marketing, uma página de destino é uma página da web independente para onde um visitante é direcionado depois de clicar em um link em uma entrega ou em um site.

As páginas de destino permitem direcionar seus usuários para formulários online onde é possível atualizar seus dados, optar por receber ou não as comunicações ou assinar um serviço específico, como um boletim informativo.
...
<td>
<a href="create-lp.md">
<img alt="Criar páginas de destino usando modelos pré-preenchidos" src="../assets/do-not-localize/lp-subscription.jpeg">
</a>
...
<img alt="Configurar serviços de assinatura para usuários" src="../assets/do-not-localize/lp-list.jpg">
</a>
<div>
...
<img alt="Criar páginas de destino responsivas" src="../assets/do-not-localize/lp-design.jpg">
</a>
<div>
...
<img alt="Trabalhar com modelos de conteúdo para páginas de destino" src="../assets/do-not-localize/lp-reporting.jpg">
</a>
<div>
