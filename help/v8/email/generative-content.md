...
1. Personalize seu layout conforme necessário e acesse o menu do **[!UICONTROL Assistente de IA]**.
   ...
   ![Captura de tela mostrando o menu do Assistente de IA na Adobe Campaign Web](assets/full-email-1.png){zoomable="yes"}
...
1. No menu à direita, selecione **[!UICONTROL Assistente do AI]**.
   ...
   ![Captura de tela mostrando o menu do Assistente de IA para geração de imagem na Adobe Campaign Web](assets/image-genai-1.png){zoomable="yes"}
