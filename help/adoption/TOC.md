---
audience: end-user
user-guide-title: Guia de adoção de campanha
title: Guia de adoção do Adobe Campaign
user-guide-description: Usuários do Campaign Standard que estão fazendo a transição para o Campaign v8, saibam como começar.
description: Usuários do Campaign Standard, aprendam como começar a usar o Campaign v8.
...
+ [Guia de adoção de campanha](home.md)
+ [Do Padrão para a v8](get-started/overview.md)
